...
//		
//		StartChord.init("127.0.0.1", "8080");
//		
//		byte[] z = new byte[20];
//
...
//	}
//	
//	public static ChordImpl addChord(ID id, int port, int bootPort, NotifyCallback cb) {
//		ChordImpl chord = new ChordImpl(); 
//		String protocol = URL.KNOWN_PROTOCOLS.get(URL.SOCKET_PROTOCOL);
//		URL localURL = null;
//		try {
//			localURL = new URL(protocol + "://127.0.0.1:" + port + "/");
//		} catch (MalformedURLException e) {
//			throw new RuntimeException(e);
//		}
//		URL bootstrapURL = null;
//		try {
//			bootstrapURL = new URL(protocol + "://127.0.0.1:" + bootPort + "/");
//		} catch (MalformedURLException e) {
//			throw new RuntimeException(e);
//		}
//
